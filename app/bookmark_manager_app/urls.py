...
urlpatterns = [
    ...
    path('<str:name>/bookmark/<int:bookmark_id>', views.bookmark.view_bookmark, name='view_bookmark'),
    path('<str:name>/bookmark/<int:bookmark_id>/removetag/<int:tagid>', views.bookmark.remove_tag_from_bookmark, name='remove_tag'),
    path('<str:name>/bookmark/<int:bookmark_id>/addtag/<int:tagid>', views.bookmark.add_tag_to_bookmark, name='add_tag'),
    path('<str:name>/bookmark/<int:bookmark_id>/changegroup/<int:groupid>', views.bookmark.change_group_of_bookmark, name='change_group'),
    path('<str:name>/bookmark/<int:bookmark_id>/addreminder', views.bookmark.add_reminder, name = 'addreminder'),
    ...
    path('<str:name>/deletegroup', views.display.delete_group, name='delete_group'),
    path('<str:name>/deletetag', views.display.delete_tag, name='delete_tag'),
    path('<str:name>/deletereminder/<str:reminder>', views.display.delete_reminder, name='delete_reminder'),
